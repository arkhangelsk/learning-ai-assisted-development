...
5. [Getting Started With Agentic Development](./docs/getting-started-agentic-development.md) - a quick-start guide to using AI tools for software development, including setup instructions and best practices for getting the most out of these tools.
