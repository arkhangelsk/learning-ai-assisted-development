# Top AI Builders and Content Sources (Blogs, Podcasts, YouTube, X)

Use this list to follow the people and sources shaping AI development, and to stay current on new tools, models, and techniques as they emerge.
...
[OpenAI](https://x.com/OpenAI), [Claude AI](https://x.com/claudeai), [Anthropic](https://x.com/AnthropicAI), [VS Code](https://x.com/code), [Github](https://x.com/github), [LangChain](https://x.com/LangChain)  

### AI Builders on Linkedin
...
- [VS Code Team Official Channel](https://www.youtube.com/@code)
- [Claude](https://www.youtube.com/@claude)
- [IBM Technology](https://www.youtube.com/@IBMTechnology)
- [Burke Holland](https://www.youtube.com/@BurkeHolland)
- [James Montemagno](https://www.youtube.com/@JamesMontemagno)
- [Sean Kochel](https://www.youtube.com/@iamseankochel)
- [Eric W](https://www.youtube.com/@EricWTech)
- [Matt Pocock](https://www.youtube.com/@mattpocockuk)
- [Teachers Tech](https://www.youtube.com/@TeachersTech)
